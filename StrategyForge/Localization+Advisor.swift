...
extension L10n {
    ...
    static let advisorStrings: [String: (en: String, es: String)] = [
        ...
        "advisor.source.ai.full": ("Apple Intelligence", "Apple Intelligence"),
        "advisor.source.local.full": ("Local engine", "Motor local"),
        ...
        "advisor.tier.econ": ("Economy", "Económica"),
        "advisor.tier.econ.note": ("Cheapest & fastest", "Lo más barato y rápido"),
        "advisor.tier.value": ("Value", "Ligera"),
        "advisor.tier.value.note": ("Cheaper & faster — good for most", "Más barata y rápida — vale para casi todo"),
        "advisor.tier.high": ("High", "Alta"),
        ...
        "advisor.inline.showTeam": ("See the team", "Ver el equipo"),
        "advisor.inline.hideTeam": ("Hide the team", "Ocultar el equipo"),
