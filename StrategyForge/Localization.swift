...
enum L10n {
    ...
    static let strings: [String: (en: String, es: String)] = [
        ...
        "map.mode.code": ("Code", "Código"),
        "map.mode.agents": ("Agents", "Agentes"),
        "map.mode.help": ("Switch between the code knowledge graph and the live agent graph.",
                          "Cambia entre el grafo de código y el grafo de agentes en vivo."),
        "map.agents.idle.title": ("No agents running", "No hay agentes en marcha"),
        "map.agents.idle.detail": ("Start a team chat and watch it execute here — the orchestrator fanning out to workers, live.",
                                   "Inicia un chat de equipo y míralo ejecutarse aquí — el orquestador repartiendo a los agentes, en vivo."),
