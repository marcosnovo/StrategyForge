...
enum L10n {
    ...
    static let strings: [String: (en: String, es: String)] = [
        ...
        "strat.execadv.tag": ("Guided build", "Con guía"),
        "strat.scout.tag": ("Explore first", "Explora antes"),
        "strat.triage.tag": ("Route by cost", "Enruta por coste"),
        "strat.planner.tag": ("Plan & ship", "Planifica y entrega"),
        "strat.rootcause.tag": ("Debug", "Depurar"),
        "strat.domain.tag": ("Full-stack", "Full-stack"),
        "strat.research.tag": ("Explore", "Explorar"),
        "strat.debate.tag": ("Design decision", "Decisión de diseño"),
        "strat.sparring.tag": ("Harden", "Endurecer"),
        "strat.solo.tag": ("Quick fix", "Arreglo rápido"),
        ...
        "strat.scout.good": ("Changes in unfamiliar code, where exploring cheaply first saves tokens.",
                             "Cambios en código desconocido, donde explorar barato primero ahorra tokens."),
        ...
        "strat.rootcause.good": ("Stubborn bugs you must fix at the root cause, not the symptom.",
                                 "Bugs persistentes que hay que arreglar en la causa, no en el síntoma."),
        "strat.rootcause.not": ("Quick edits or building new features.",
                                "Ediciones rápidas o crear funciones nuevas."),
