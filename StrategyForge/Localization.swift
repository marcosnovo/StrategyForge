...
enum L10n {
    ...
    static let strings: [String: (en: String, es: String)] = [
        ...
        "provider.issue.migrateAntigravity.detail": ("Google no longer supports the free Gemini CLI for individuals. Install Antigravity (the agy CLI) and sign in there — Coral uses it automatically.",
                                                     "Google ya no admite el CLI gratuito de Gemini para particulares. Instala Antigravity (el CLI agy) e inicia sesión ahí — Coral lo usa automáticamente."),
