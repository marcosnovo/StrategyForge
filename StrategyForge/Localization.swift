...
enum L10n {
    ...
    static let strings: [String: (en: String, es: String)] = [
        ...
        "effort.fast": ("Fast", "Rápido"),
        "effort.medium": ("Medium", "Medio"),
        "effort.high": ("High", "Alto"),
        "effort.ultra": ("Ultracode", "Ultracode"),
        "effort.fast.blurb": ("Answers quickly with the least thinking — best for simple asks.",
                              "Responde rápido con el mínimo de reflexión — ideal para peticiones simples."),
        "effort.medium.blurb": ("A balanced amount of thinking before answering.",
                                "Una cantidad equilibrada de reflexión antes de responder."),
        "effort.high.blurb": ("Thinks hard before answering — better for tricky tasks.",
                              "Piensa a fondo antes de responder — mejor para tareas difíciles."),
        "effort.ultra.blurb": ("Maximum reasoning — slowest and most thorough, for the hardest problems.",
