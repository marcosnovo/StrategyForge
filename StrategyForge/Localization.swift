...
enum L10n {
    ...
    static let strings: [String: (en: String, es: String)] = [
        ...
        "map.deep": ("Deep", "Profundo"),
        "map.deep.help": ("Also read docs, PDFs and images (uses Claude tokens). Off = code only, deterministic and free.",
                          "También lee docs, PDFs e imágenes (gasta tokens de Claude). Apagado = solo código, determinista y gratis."),
        ...
        "map.ready.desc": ("Build a knowledge graph of the selected repo — deterministic and token-cheap in light mode.",
                           "Construye un grafo de conocimiento del repo seleccionado — determinista y barato en tokens en modo ligero."),
        "map.running": ("Building the map…", "Construyendo el mapa…"),
        "map.installing": ("Installing graphify…", "Instalando graphify…"),
        "map.notInstalled.title": ("graphify isn't installed", "graphify no está instalado"),
        "map.notInstalled.desc": ("The Map uses the open-source graphify CLI (a Python tool) to parse your code locally.",
                                  "El Mapa usa la CLI open-source graphify (una herramienta de Python) para parsear tu código localmente."),
        "map.install": ("Install graphify", "Instalar graphify"),
