...
enum L10n {
    ...
    static let strings: [String: (en: String, es: String)] = [
        ...
        "team.draft.back": ("Strategies", "Estrategias"),
        "chat.autoTeam": ("Team chosen for your task: %@", "Equipo elegido para tu tarea: %@"),
        "chat.autoTeam.badge": ("Auto team", "Equipo automático"),
        "chat.autoTeam.title": ("The team is chosen from your first message", "El equipo se elige según tu primer mensaje"),
        "chat.autoTeam.desc": ("Just describe your task below — I'll pick the agents that fit. You can always change the team afterwards.",
                               "Describe tu tarea abajo — elegiré los agentes que encajen. Siempre puedes cambiar el equipo después."),
        ...
        "usage.subtitle": ("Token usage per connected platform, from your local logs.",
                           "Uso de tokens por plataforma conectada, desde tus registros locales."),
        ...
        "team.members.section": ("Agents", "Agentes"),
        "team.members.count": ("%lld agents", "%lld agentes"),
        "team.add": ("Add agent", "Añadir agente"),
        "team.add.help": ("Add a new teammate to this team", "Añade un nuevo compañero a este equipo"),
        "team.delete": ("Remove this agent", "Eliminar este agente"),
        "team.flow.note": ("The orchestrator delegates to each agent. Agents work in parallel and report back — they don't talk to each other.",
                            "El orquestador delega en cada agente. Los agentes trabajan en paralelo e informan de vuelta — no se comunican entre sí."),
        ...
        "settings.connected.caption": ("Run your chats on different AIs using your own subscription logins — no API keys. Install each provider's command-line app (CLI) and sign in there; Coral detects it automatically.",
                                       "Ejecuta tus chats en distintas IAs con tus propios inicios de sesión — sin claves API. Instala la app de línea de comandos (CLI) de cada proveedor e inicia sesión ahí; Coral la detecta automáticamente."),
        ...
        "strat.fanout.name": ("Team lead + parallel workers", "Jefe de equipo + trabajadores en paralelo"),
        ...
        "strat.debate.name": ("Debate / Consensus (with a moderator)", "Debate / Consenso (con moderador)"),
        ...
        "strat.triage.name": ("Sorter — easy jobs cheap, hard jobs to the expert", "Clasificador — lo fácil barato, lo difícil al experto"),
        ...
        "import.done": ("Imported a strategy with %lld teammates.", "Importada una estrategia con %lld compañeros."),
        ...
        "effort.level.ultra": ("Ultracode", "Ultracode"),
