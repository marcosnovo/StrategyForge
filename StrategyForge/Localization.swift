...
enum L10n {
    ...
    static let strings: [String: (en: String, es: String)] = [
        ...
        "skills.top.note": ("The current official Anthropic skills catalog, fetched live. A green check marks the ones you already have installed.",
                            "El catálogo oficial actual de skills de Anthropic, en vivo. El check verde marca las que ya tienes instaladas."),
