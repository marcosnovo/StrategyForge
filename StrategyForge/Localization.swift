...
enum L10n {
    ...
    static let strings: [String: (en: String, es: String)] = [
        ...
        "provider.test.hint": ("Sends one tiny prompt through this CLI to verify it runs.",
                               "Envía un prompt mínimo por esta CLI para verificar que funciona."),
        ...
        "usage.empty": ("No Claude usage found in ~/.claude yet. Use Claude Code and refresh.",
                        "Aún no hay uso de Claude en ~/.claude. Usa Claude Code y actualiza."),
        "usage.noWeek": ("No activity in the last 7 days", "Sin actividad en los últimos 7 días"),
        "usage.noProviderData": ("No local usage available via its CLI",
                                 "Sin datos de uso locales disponibles vía su CLI"),
        ...
        "team.add.help": ("Add a new subagent to this team", "Añade un nuevo subagente a este equipo"),
