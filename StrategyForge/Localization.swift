...
enum L10n {
    ...
    static let strings: [String: (en: String, es: String)] = [
        ...
        "chat.secondOpinion.help": ("Ask %@ the same question and compare — cross-provider, no single vendor can do this.",
                                    "Pregunta lo mismo a %@ y compara — cross-provider, ningún proveedor único puede hacer esto."),
