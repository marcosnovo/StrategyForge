...
extension L10n {
    ...
    static let runStrings: [String: (en: String, es: String)] = [
        ...
        "settings.updates.available.row": ("Update available: %@", "Actualización disponible: %@"),
        "settings.updates.banner": ("A new version is available: %@", "Hay una nueva versión disponible: %@"),
        "settings.updates.download": ("Download", "Descargar"),
        "settings.updates.badge": ("An update is available", "Hay una actualización disponible"),
        "settings.updates.changelog": ("What's new", "Novedades"),
        "settings.updates.changelog.empty": ("No release notes could be loaded right now.",
                                             "No se han podido cargar las novedades ahora mismo."),
        "settings.updates.changelog.none": ("_No notes for this version._", "_Sin notas para esta versión._"),
        "settings.updates.version": ("Version %@", "Versión %@"),
        "settings.updates.installed": ("Installed", "Instalada"),
