...
| **P1** | **Transparencia app-wide:** que ninguna operación larga parezca congelada (progreso en vivo en todo) | Máxima del founder: "si parece bloqueado, nadie lo usa". En curso (chat, evals/RAI hechos). |
